...
## Usage
To create the full data analysis the script 00.doit.R found in /R should be run (ensure that all packages are installed). This will run all scripts and create all final plots. A presentation of the project can be found in /doc. The shiny app can be found in /covid_app and is published on shinyapps.io  https://r-kursus.shinyapps.io/covid_app.
