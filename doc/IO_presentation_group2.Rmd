...
<font size="4"> 1. Days from December 1st 2019 to 100 deaths <br>
2. Days from 100 cases to 100 deaths </br> </font> 
<br>
<br>
<font size="5"> Hypothesis:</font>
<font size="5"> Demographic factors like urbanisation and age distribution affects COVID-19 kinetics</font>
...
<div class="columns-2">
  ...
  - <font size="3"> Relative COVID-19 deaths were more informative than absolute deaths </font>
  - <font size="3"> PC1 comprises 44.6% of variation with life expentancy as the strongest driver of PC1 </font>
  ![](../results/04_analysis_PCA/PC_significance.png){ width=65%, height=65% }
